...
4. Rename `.env.local.example` to `.env.local` and update the following:
   ...
   ```
   PUBLIC_SUPABASE_URL=[INSERT SUPABASE PROJECT URL]
   PUBLIC_SUPABASE_ANON_KEY=[INSERT SUPABASE PROJECT API ANON KEY]
   ```

   Both `PUBLIC_SUPABASE_URL` and `PUBLIC_SUPABASE_ANON_KEY` can be found in [your Supabase project's API settings](https://app.supabase.com/project/_/settings/api)
